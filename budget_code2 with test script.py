...
new_user.add_pm('credit',1635, 2000)
new_user.add_pm('debit', 8934, 8000)

new_user.change_pm_budget( 1635, 250)

new_user.add_category(8934,'food', 200, 150)
new_user.add_category(1635, 'Miscellaneous', 200, 50)
new_user.add_category(8934, 'Gas', 30, 20)

print(new_user.payment_profiles)

print(f"\nRenaming {new_user.payment_profiles[8934][0]} to Savings:")
new_user.rename_pm(8934, 'Savings')

print(new_user.payment_profiles)

print(f"\nAdding Bills category to {new_user.payment_profiles[8934][0]}:")
new_user.add_category(8934, 'Bills', 300, 100)

print(new_user.payment_profiles)

print(f"\nRemoving Gas from {new_user.payment_profiles[8934][0]}:")
new_user.remove_category(8934, 'Gas')

print(new_user.payment_profiles)

print("\nBuying $50 worth on food:")
new_user.transaction_both(8934, 'food', 50 )

print(new_user.payment_profiles)

print("\nSpending $50 worth on miscellaneous:")
new_user.transaction_both(1635, 'miscellaneous', 50)

print(new_user.payment_profiles)
print("\n")

print(f"\nSpending $400 worth on Bills:")
new_user.transaction_both(8934, 'bills', 400)
